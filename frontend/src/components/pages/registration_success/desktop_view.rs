    ...
    html! {
        <AuthLayout is_admin={false}>
            <div class="ml-4 p-10 min-h-screen bg-white w-[50vw] flex flex-col justify-center items-center gap-4">
                <lottie-player src="https://assets2.lottiefiles.com/packages/lf20_pa8zadja.json"  background="transparent"  speed="1"  style="width: 300px; height: 300px;"  autoplay={true}></lottie-player>
