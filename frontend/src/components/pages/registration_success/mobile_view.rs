...
pub fn mobile_view() -> Html {
    html! {
        ...
        <div class="p-5 flex flex-col w-full items-center justify-center">
            <lottie-player src="https://assets2.lottiefiles.com/packages/lf20_pa8zadja.json"  background="transparent"  speed="1"  style="width: 250px; height: 250px;"  autoplay={true}></lottie-player>
