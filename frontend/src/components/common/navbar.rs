	   ...
	   <nav
		...
		>
		 ...
		 <div class="hidden w-full md:flex md:items-center md:w-auto" id="menu">
			...
			>
			  <li>
				<NavButton route={Route::Index} pathname={String::from("Beranda")} class="md:p-4 py-2 block text-cyan-400 hover:text-purple-400 font-bold"/>
			  </li>
			  <li>
				<NavButton route={Route::Profile} pathname={String::from("Profile")} class="md:p-4 py-2 block text-cyan-400 hover:text-purple-400 font-bold"/>
			  </li>
			  <li>
